@extends('admin.ADtemplate.ADmaster')
        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            <div align="right">
              <td>
                <button type="button" name="edit" id="pheduyet" class="edit btn btn-primary btn-sm">Phê duyệt</button>&nbsp;
            ...
            <div class="table-responsive">
              <table class="table table-bordered yeucau" id="dataTableYeuCau" width="100%" cellspacing="0">
...
$('.checkall').change(function() {
    var checkboxes = $(this).closest('.yeucau').find(':checkbox');
...
$('.status:checked').each(function(){
 ...
 if(id.length > 0)
    ...
    $('#pheduyet_button').text('Đang xử lý...');
            ...
            { $('#confirmModal0').modal('hide');
                alert("Bạn chưa chọn yêu cầu cần xử lý");
            }
...
$('.status:checked').each(function(){
 ...
 if(id.length > 0)
    ...
    $('#ok_button').text('Đang xóa...');
            ...
            { $('#confirmModal').modal('hide');
                alert("Bạn chưa chọn yêu cầu cần xóa");
            }
