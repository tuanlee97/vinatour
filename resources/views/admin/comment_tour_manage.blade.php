        ...
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered cmt_tour" id="dataTableComment_Tour" width="100%" cellspacing="0">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4 id="confirmtext" align="center" style="margin:0;">Bạn có muốn đánh dấu đã đọc những bình luận này?</h4>
                <span id="result">
...
$(document).ready(function(){
 ...
 $('#dataTableComment_Tour').DataTable({
  processing: true,
  serverSide: true,
  ajax:{
   url: "{{ route('comment_tour.index') }}",
  },
  columns:[
...
$('.checkall').change(function() {
    var checkboxes = $(this).closest('.cmt_tour').find(':checkbox');
 ...
 if(id.length > 0)
    ...
    $('#pheduyet_button').text('Đang xử lý...');
               ...
               $('#confirmModal0').modal('hide');
                 $('#dataTableComment_Tour').DataTable().ajax.reload();
              }, 1000);
                    }
                });
            }
            ...
            { $('#confirmModal0').modal('hide');
                alert("Bạn chưa chọn bình luận cần xử lý");
            }
...
$('.status:checked').each(function(){
 ...
 if(id.length > 0)
    ...
    $('#ok_button').text('Đang xóa...');
            ...
            { $('#dataTableComment_Tour').modal('hide');
                alert("Bạn chưa chọn bình luận cần xóa");
            }
