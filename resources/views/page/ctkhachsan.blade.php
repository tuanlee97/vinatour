			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-9">
						...
						</div><script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.3&appId=323774901635384&autoLogAppEvents=1"></script>
<div class="fb-comments" data-href="https://vinatour.tk/ctkhachsan/{{$khachsan->id}}" data-width="" data-numposts="5"></div>
					</div>
